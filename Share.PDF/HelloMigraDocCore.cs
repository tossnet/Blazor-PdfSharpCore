...
{
    public static byte[] GetRendered()
    {
    ...
    private static void DemonstrateIndent(Document document)
    {
        ...
        paragraph.AddText("FillerText.Text 4");
    }
    ...
    public static void DemonstrateBigTable(Document document)
    {
        document.LastSection.AddParagraph("Long Tables", "Heading2");
